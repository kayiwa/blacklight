...
['blacklight-core', 'blacklight-bootstrap2', 'blacklight'].each do |framework|
...
namespace :all do
  task :build   => ['blacklight-core:build', 'blacklight-bootstrap2:build', 'blacklight:build']
  task :install => ['blacklight-core:install', 'blacklight-bootstrap2:build', 'blacklight:install']
  task :push    => ['blacklight-core:push', 'blacklight-bootstrap2:build', 'blacklight:push']
